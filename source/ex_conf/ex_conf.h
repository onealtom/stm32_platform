...
//#define HXCT_VER					// 虹信
//#define CLIENT_JIZHUN				//	基准
//#define CLIENT_DATANG			// 大唐
...
#define USER_NET_TYPE_A				NET_TYPE_TETRA		// A段网络制式
#define USER_NET_TYPE_B				NET_NONE			// B段网络制式
#define USER_NET_TYPE_C				NET_NONE// C段网络制式
#define USER_NET_TYPE_D				NET_NONE// D段网络制式
#define FPGA_DATA_CLK_A				12.288	//A段FPGA数据时钟
#define FPGA_DATA_CLK_B				62.5//B段FPGA数据时钟
#define FPGA_DATA_CLK_C				62.5//C段FPGA数据时钟
#define FPGA_DATA_CLK_D				62.5//D段FPGA数据时钟
...
#define USER_NET_TYPE_C				NET_NONE// C段网络制式
#define USER_NET_TYPE_D				NET_NONE// D段网络制式
#define FPGA_DATA_CLK_A				61.44	//A段FPGA数据时钟
#define FPGA_DATA_CLK_B				62.5//B段FPGA数据时钟
#define FPGA_DATA_CLK_C				62.5//C段FPGA数据时钟
#define FPGA_DATA_CLK_D				62.5//D段FPGA数据时钟
...
#define USER_NET_TYPE_A				NET_TYPE_GSM900		// A段网络制式
#define USER_NET_TYPE_B				NET_NONE			// B段网络制式
#define USER_NET_TYPE_C				NET_TYPE_LTE_TD// C段网络制式
#define USER_NET_TYPE_D				NET_TYPE_LTE_TD// D段网络制式
#define FPGA_DATA_CLK_A				61.44//A段FPGA数据时钟
#define FPGA_DATA_CLK_B				61.44//B段FPGA数据时钟
#define FPGA_DATA_CLK_C				61.44//C段FPGA数据时钟
#define FPGA_DATA_CLK_D				61.44//D段FPGA数据时钟

#elif defined CLIENT_ERRICSON2
#define USER_NET_TYPE_A				NET_NONE		// A段网络制式
#define USER_NET_TYPE_B				NET_NONE			// B段网络制式
...
#define USER_NET_TYPE_C				NET_NONE// C段网络制式
#define USER_NET_TYPE_D				NET_NONE// D段网络制式
#define FPGA_DATA_CLK_A				62.5	//A段FPGA数据时钟
#define FPGA_DATA_CLK_B				62.5//B段FPGA数据时钟
#define FPGA_DATA_CLK_C				62.5//C段FPGA数据时钟
#define FPGA_DATA_CLK_D				62.5//D段FPGA数据时钟
#define MAJOR_VERSION		VERSION_GEDT_ERRICSON_C
